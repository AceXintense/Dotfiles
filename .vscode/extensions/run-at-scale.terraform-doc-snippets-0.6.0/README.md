...
- Issue [#1](https://github.com/run-at-scale/vscode-terraform-doc-snippets/issues/1) is probably that this is my first node project and I'm not to be trusted with the language. Help and review wanted! Tests needed.
